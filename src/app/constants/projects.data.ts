...
export const angularData: IProject[] = [
  {
    id: '4e8e9d5c',
...
export const jsData: IProject[] = [
  {
    id: '4e8e9d5c',
    image: '/images/game-over.png',
    title: 'Game Over',
    description: "A simple movies website built using HTML, CSS, Bootstrap, and pure JavaScript. movies and movie details and login, register authentication",
    langs: ['HTML', 'CSS', 'Bootstrap', 'JavaScript'],
    websiteDemo: 'https://ahmedya3ser8.github.io/Game-Over/'
  },
  {
    id: '4e8ealva5c',
    image: '/images/special-design.png',
    title: 'Special Design',
    description: "Website built using HTML, CSS, and pure JavaScript.",
    langs: ['HTML', 'CSS', 'JavaScript'],
    websiteDemo: 'https://ahmedya3ser8.github.io/Special-Design/'
  },
  {
    id: 'be8ad5e',
    image: '/images/financial.png',
    title: 'Finance Business',
    description: "A simple landing page built using HTML, CSS, Bootstrap, and pure JavaScript.",
    langs: ['HTML', 'CSS', 'Bootstrap', 'JavaScript'],
    websiteDemo: 'https://ahmedya3ser8.github.io/Finance_Business/'
  },
  {
    id: 'brtad5q',
    image: '/images/bookmark.png',
    title: 'Simple Bookmark',
    description: "Simple CRUD (Create, Read, Update, Delete) system implemented using HTML, CSS, JavaScript, Bootstrap.",
    langs: ['HTML', 'CSS', 'Bootstrap', 'JavaScript'],
    websiteDemo: 'https://ahmedya3ser8.github.io/Bookmark/'
  },
  {
    id: 'brpoad5q',
    image: '/images/weather.png',
    title: 'Weather App',
    description: "Simple Weather App implemented using HTML, CSS, JavaScript, Bootstrap.",
    langs: ['HTML', 'CSS', 'Bootstrap', 'JavaScript'],
